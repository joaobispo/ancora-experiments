...
/**
 * Iteratively builds a TracePattern from a TraceFlow.
 *
 * @author Joao Bispo
 */
public class PatternFinderIterative {
...
//      System.out.println("Ratio Inst in Loop / Total Inst:"+rationInstLoopsTotalInsts);
   ...
   public PatternFinderIterative(int patternSize) {
     // Check Pattern Size
      if(patternSize > 32) {
         Logger.getLogger(PatternFinderIterative.class.getName()).
   ...
   public static void patternFinder(TraceFlow traceFlow, File outputFile, int windowSize) {
      ...
      PatternFinderIterative patternFinder = new PatternFinderIterative(windowSize);
      resetStats();
