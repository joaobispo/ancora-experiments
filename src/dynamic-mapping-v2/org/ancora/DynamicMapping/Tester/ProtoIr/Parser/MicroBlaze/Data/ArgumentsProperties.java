...
import static org.ancora.DynamicMapping.Tester.ProtoIr.Parser.MicroBlaze.Data.ArgumentsProperties.ArgumentProperty.*;
...
public class ArgumentsProperties {
    ...
    */
   public static final Map<InstructionType, ArgumentProperty[]> argumentsProperties;

   static {
      Map<InstructionType, ArgumentProperty[]> aMap = new Hashtable<InstructionType, ArgumentProperty[]>();
   ...
   public static ArgumentProperty[] getProperties(InstructionType type) {
      ArgumentProperty[] props = argumentsProperties.get(type);
      if (props == null) {
         Logger.getLogger(ArgumentsProperties.class.getName()).
                 warning("Instruction type '" + type.getName() + "' not present in table. Returning " +
                 "empty array.");
