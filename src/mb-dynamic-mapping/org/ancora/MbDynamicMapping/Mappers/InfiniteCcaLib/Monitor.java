...
public class Monitor {
   ...
   public void addMoveInstructions(int numberOfMoves) {
      this.totalMoveInstructions += numberOfMoves;
   }

   public void addMappedInstructions(int numberOfInstructions) {
      this.totalMappedInstructions += numberOfInstructions;
   }

   public void addTotalInstructions(int numberOfInstructions) {
      this.totalInstructions += numberOfInstructions;
   }
