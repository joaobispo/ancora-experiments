...
public enum TraceflowPreferences implements EnumKey {
    ...
    * @param defaultValue
    */
   private TraceflowPreferences(String defaultValue) {
   ...
   private static EnumPreferences initializePreferences() {
      ...
      PropertiesFile propsDef = new TraceflowProperties();

      // Build Preferences
      EnumPreferences newPreferences = new EnumPreferences(TraceflowPreferences.class, true);
