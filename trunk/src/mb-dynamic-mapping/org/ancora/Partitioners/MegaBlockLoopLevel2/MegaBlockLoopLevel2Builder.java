 ...
 * @author Joao Bispo
 */
public class MegaBlockLoopLevel2Builder extends InstructionBlockSource implements InstructionBlockListener {


   public MegaBlockLoopLevel2Builder(int maxPatternSize) {
      initCurrentLoop();
      initPatternLoop();
